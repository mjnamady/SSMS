        ...
        <div class="col-xl-12">
            <div class="card" id="accordion-three">
                <div class="card-header flex-wrap d-flex justify-content-between px-3">
                    <div>
                    <h4 class="card-title">Assigned Subjects List</h4>
                    </div>
                    <a href="{{ route('add.assign.subject') }}" type="button" class="btn btn-primary">+ Add Assign Subject</a>
                </div>
            ...
            <tr>
                <td> {{ $key+1 }} </td>
                <td>{{ $data['studentSubject']['name'] }}</td>
