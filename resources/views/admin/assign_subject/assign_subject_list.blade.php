                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table id="example3" class="display table" style="min-width: 845px">
                                        ...
                                        <tbody>
                                @foreach ($assign_subject_all as $key => $assign_subject)

                                <tr>
                                    <td> {{ $key+1 }} </td>
                                    <td>{{ @$assign_subject['studentClass']['name'] }}</td>
                                
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ route('assign.subject.edit', $assign_subject->class_id) }}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                                            <a href="{{ route('assign.subject.details', $assign_subject->class_id) }}" class="btn btn-danger shadow btn-xs sharp"><i class="fa-sharp fa-solid fa-eye"></i></a>
