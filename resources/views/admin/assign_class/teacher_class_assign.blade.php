        ...
        <div class="col-xl-8">
            <div class="card h-auto">
                ...
                <div class="card-body">
                    ...
                    <h3>Assign Class(es)</h3>
                    <div class="row mt-2">
                        
                        <form method="POST" action="{{route('store.teacher.class', $user->id)}}">
                            @csrf
                            <div class="mb-3">
                                <label class="form-label">Classes:</label>
                                <select name="classes[]" multiple class="default-select  form-control wide" required>
        ...
        <div class="col-xl-4">
            <div class="row">
                <div class="col-xl-12 col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="heading">Assigned Class(es)</h3>
                            
                            @php
                                $user_classes = $user->teacher->classes;
                            @endphp
                                        ...
                                        <div class="basic-list-group">
                                            <ul class="list-group">
                                                @foreach ($user_classes as $class)
                                                    <li class="list-group-item"><b>{{$class->name}}</b>
                                                        <a href="{{route('un.assign.class',[$class->id, $user->id])}}" id="delete" style="float: right">
