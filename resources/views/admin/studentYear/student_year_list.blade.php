        ...
        <div class="col-xl-12">
            <div class="card" id="accordion-three">
                <div class="card-header flex-wrap d-flex justify-content-between px-3">
                    <div>
                    <h4 class="card-title">All Student Year List</h4>
                    </div>
                    <a href="{{ route('add.student.year') }}" type="button" class="btn btn-primary">+ Add Year</a>
                </div>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex">
                        <a href="{{ route('edit.student.year', $year->id) }}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                        <a href="{{ route('delete.student.year', $year->id) }}" id="delete" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
