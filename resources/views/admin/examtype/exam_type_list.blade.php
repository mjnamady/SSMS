        ...
        <div class="col-xl-12">
            <div class="card" id="accordion-three">
                <div class="card-header flex-wrap d-flex justify-content-between px-3">
                    ...
                    <a href="{{ route('add.exam.type') }}" type="button" class="btn btn-primary">+ Add Exam Type</a>
                </div>
                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table id="example3" class="display table" style="min-width: 845px">
                                        ...
                                        <tbody>
            @foreach ($examtype_all as $key => $examtype)
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex">
                        <a href="{{ route('edit.exam.type', $examtype->id) }}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                        <a href="{{ route('delete.exam.type', $examtype->id) }}" id="delete" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
