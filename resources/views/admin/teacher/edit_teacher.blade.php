            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">Edit Teacher's Profile</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xl-3 col-lg-3">
                                ...
                                <div class="avatar-upload">
                                    <div class="avatar-preview">
                                        <div > 
                                            <img id="showImage" src="{{ (!empty($user->photo)) ? url('uploads/teacher/'.$user->photo) : url('uploads/no_image.jpg') }}" style="width:90px" alt="">		
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-4 col-sm-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select name="religion" class="default-select form-control wide" aria-label="Default select example" tabindex="null">
                                                ...
                                                <option value="Islam" {{ (!empty($user->religion) && $user->religion == 'Islam') ? 'selected' : '' }} >Islam</option>
                                                <option value="Christianity" {{ (!empty($user->religion) && $user->religion == 'Christianity') ? 'selected' : '' }} >Christianity</option>
                                                <option value="Traditional" {{ (!empty($user->religion) && $user->religion == 'Traditional') ? 'selected' : '' }} >Traditional</option>
                                              </select>
                                        </div>
                                    ...
                                    <div class="col-xl-4 col-sm-4">
                                        ...
                                        <div class="mb-3">                          
                                            <label  class="form-label text-primary">Date of Birth<span class="required">*</span></label>
                                                <div class="d-flex">
                                                    <input type="text" name="dob" class="form-control" id="mdate" value="{{$user->teacher->dob}}">
                                                </div>
                                        </div>
