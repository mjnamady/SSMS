                    ...
                    <div class="d-flex justify-content-between">
                        <div class="user">
                            ...
                            <div>
                                ...
                                <p  class="text-primary font-w600">{{(@$user->teacher->subjects != null)?@$user->teacher->subjects->first()->name. ' ' .$user->role : ''}}</p>
                            </div>
                        </div>
                        <div class="dropdown custom-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="{{route('edit.teacher', $user->id)}}">Edit Profile</a>
                                <a class="dropdown-item" href="{{ route('teacher.subject', $user->id) }}">Assign Subject</a>
                                <a class="dropdown-item" href="javascript:void(0);">Assign Class</a>
                            </div>
                        </div>
                    </div>	
                    <div class="row mt-2">
                        <div class="col-xl-3 col-xxl-6 col-sm-6">
                            <ul class="student-details">
                                ...
                                <li>
                                    <span>Religion:</span>
                                    <h5 class="mb-0">{{$user->religion}}</h5>
                                </li>
                            </ul>
                        </div>
                        <div class="col-xl-3 col-xxl-6 col-sm-6">
                        ...
                        <div class="col-xl-3 col-xxl-6 col-sm-6">
                            <ul class="student-details">
                                ...
                                <li>
                                    ...
                                    <h5 class="mb-0">{{$user->teacher->dob}}</h5>
                                </li>
                            </ul>
                        </div>
                    </div>
