        ...
        <div class="col-xl-12">
            <div class="card" id="accordion-three">
                <div class="card-header flex-wrap d-flex justify-content-between px-3">
                    <div>
                    <h4 class="card-title">All Student Class List</h4>
                    </div>
                    <a href="{{ route('add.student.class') }}" type="button" class="btn btn-primary">+ Add Class</a>
                </div>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex">
                        <a href="{{ route('edit.student.class', $class->id) }}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                        <a href="{{ route('delete.student.class', $class->id) }}" id="delete" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
