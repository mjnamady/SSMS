...
<!-- Mirrored from akademi.dexignlab.com/xhtml/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Dec 2023 16:36:21 GMT -->
<head>
   <!-- All Meta -->
	<meta charset="utf-8">
	...
	<!-- Page Title Here -->
	<title>SSMS | Secondary Management System</title>
		...
		<div class="login-aside text-center  d-flex flex-column flex-row-auto">
			<div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
				<div class="text-center mb-lg-4 mb-2 pt-5 logo">
					{{-- <img src="{{asset('backend/images/logo-white.png')}}" alt=""> --}}
                    <h2 style="font-weight:bold; margin:auto 0px;color:#FB7D5B">SSMS</h2>
				</div>
			...
			<div class="aside-image position-relative" style="background-image:url(images/background/pic-2.png);">
				<img class="img1 move-1" src="{{asset('backend/images/background/pic3.png')}}" alt="">
				<img class="img2 move-2" src="{{asset('backend/images/background/pic4.png')}}" alt="">
				<img class="img3 move-3" src="{{asset('backend/images/background/pic5.png')}}" alt="">
							...
							<div id="sign-up" class="auth-form tab-pane fade show active  form-validation">
								<form method="POST" action="{{ route('login') }}">
									...
									<div class="text-center mb-4">
										<h3 class="text-center mb-2 text-black">Admin Sign In</h3>
									...
									<div class="mb-3">
										<label for="login" class="form-label mb-2 fs-13 label-color font-w500">Email address / Phone Number</label>
									  <input type="text" name="login" class="form-control @error('login') is-invalid @enderror" id="login" placeholder="hello@example.com / 08140699104">
                                      @error('login')
...
<!-- Mirrored from akademi.dexignlab.com/xhtml/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 18 Dec 2023 16:36:23 GMT -->
</html>