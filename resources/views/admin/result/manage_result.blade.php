        ...
        <div class="col-xl-12">
            <div class="card" id="accordion-three">
                <div class="card-header flex-wrap d-flex justify-content-between px-3">
                    ...
                    <a href="{{ route('add.result') }}" type="button" class="btn btn-primary">+ Add Result</a>
                </div>
            ...
            <tr>
                <td><strong>{{ $result['student']['id_no'] }}</strong></td>
                <td><img class="rounded-circle" width="35" src="{{ (!empty($result->student->user->photo)) ? url('uploads/students/'.$result->student->user->photo) : url('uploads/no_image.jpg') }}" alt=""></td>
                <td>{{$result->student->user->first_name.' '.$result->student->user->last_name}}</td>
                <td>{{ $result->student->user->gender }}</td>
                <td>{{ $result['student']['class']['name'] }}</td>
                <td>{{ $result['term']['name'] }}</td>
                <td>{{ $result['year']['name'] }}</td>
                <td>
                    <div class="d-flex">
                        <a href="{{route('view.result',$result->student_id)}}" class="btn btn-danger shadow sharp me-1"><i class="fa-sharp fa-solid fa-eye"></i></a>
                        <a href="{{route('edit.result',$result->student_id)}}" class="btn btn-primary shadow sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                        <a href="#" id="delete" class="btn btn-danger shadow sharp"><i class="fa fa-trash"></i></a>
