@php
     $adminInfo = App\Models\User::find(Auth::user()->id);
@endphp
<div class="header">
                                ...
                                <div class="card mb-0">
                                    <div class="card-header p-3">
                                        <ul class="d-flex align-items-center">
                                            <li>
                                                <img src="{{ (!empty($adminInfo->photo)) ? url('uploads/admin_images/'.$adminInfo->photo) : url('uploads/no_image.jpg') }}" class="ms-0" alt="">
                                            </li>
                                            <li class="ms-2">
                                                <h4 class="mb-0">{{ $adminInfo->first_name.' '.$adminInfo->last_name }}</h4>
                                    ...
                                    <div class="card-footer text-center p-3">
                                        <a href="{{ route('admin.logout') }}" class="dropdown-item ai-icon btn btn-primary light">
