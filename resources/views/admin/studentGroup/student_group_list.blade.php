        ...
        <div class="col-xl-12">
            <div class="card" id="accordion-three">
                <div class="card-header flex-wrap d-flex justify-content-between px-3">
                    ...
                    <a href="{{ route('add.student.group') }}" type="button" class="btn btn-primary">+ Add Group</a>
                </div>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex">
                        <a href="{{ route('edit.student.group', $group->id) }}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                        <a href="{{ route('delete.student.group', $group->id) }}" id="delete" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
